                                                ...
                                                foreach ($results as $result) {               ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a href="edit-book.php?bookid=<?php echo htmlentities($result->bookid); ?>"><button class="btn btn-primary" style="background: green;"><i class="fa fa-book "></i> Imprumuta</button>
                                                            <a href="manage-books.php?del=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('Are you sure you want to return?');"> <button class=" btn btn-danger"><i class="fa fa-exchange"></i> Returneaza</button>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
